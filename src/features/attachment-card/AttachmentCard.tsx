...
export const AttachmentCard: React.FC<Props> = ({ files, filter, onDelete, onFileClick, onUpload,truncateFileName, isJournal }) => {
    ...
    return (
        <Box className='attachment-card-box'>
            <Card className='attachment-card' elevation={5}>
                <CardContent>
                    <div style={{
                        display: 'flex',
                    }}>
                        <Typography className='attatchment-name' variant="h6">Attachments</Typography>
                        {isJournal !== true &&
